...
##
# @file tutti.py
# File documentation for tutti.py
...
##
#@brief finds the minimum rectagle around the object
#@param img the image to process
#@param name for debugging purpose
...
##
#@brief finds the rotation of the object
#@param circles array of circles around the objects
#@param image_shape for debugging purpose
